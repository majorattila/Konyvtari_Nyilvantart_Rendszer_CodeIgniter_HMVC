...
?><p style="margin-top: 30px;">
	<a href="<?php echo $create_account_url ?>"><button type="button" class="btn btn-primary margin">Új típus hozzáadása</button></a>
...
<?php
$form_location = base_url().'tipusok/manage/20';
?>
<form action="<?=$form_location?>" method="get">
<div class="row-fluid sortable">
	<div class="box box-default">
		<div class="box-header with-border" data-original-title>
		<h3 class="box-title"><i class="fa fa-fw fa-search"></i> Keresés</h3> <a href="<?=base_url()?>tipusok/manage/20"><i class="fa fa-fw fa-close"></i></a>
		...
		<div class="box-body">			
			...
			<div class="col-xs-12 col-sm-6">
				<div class="input-group">
					...
					<select id="rendez" name="rendez" class="selectpicker form-control" data-live-search="true" title="tipus_id">
						<option value="tipus_id" <?=($rendez=="tipus_id")?'selected':''?>>tipus_id</option>
				...
				<div class="box box-default">
					...
					<div class="box-body">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  ?>
							<tr>
								<td data-title="ID"><?= $row->tipus_id ?></td>	
...
<?php
$fields = array();
$ajax_url = base_url()."tipusok/truncate";
