...
<div class="row-fluid sortable">
	<div class="box box-default">
		...
		<div class="box-body">
			<a href="<?= base_url() ?>felhasznalok/delete_reserve/<?= $user_id ?>/<?= $update_id ?>"><button type="button" class="btn metro-button mtr-red mtr-round margin">Kölcsönzés Törlése</button></a>
		</div>
	</div><!--/span-->
</div><!--/row-->
<?php
...
<div class="row-fluid sortable">
	<div class="box box-default">
		...
		<?php
		$form_location = base_url()."felhasznalok/kolcsonzes_create/".$user_id.'/'.$update_id;
		?>
