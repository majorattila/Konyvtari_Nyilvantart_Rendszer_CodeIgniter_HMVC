...
<?php
$form_location = base_url().'kiadok/manage/20';
?>
		...
		<div class="box-body">			
			...
			<div class="col-xs-12 col-sm-6">
				<div class="input-group">
					...
					<select id="rendez" name="rendez" class="selectpicker form-control" data-live-search="true" title="kiado_id">
						<option value="kiado_id" <?=($rendez=="kiado_id")?'selected':''?>>kiado_id</option>
						<option value="kiado" <?=($rendez=="kiado")?'selected':''?>>kiadó</option>
		            </select>
                    <span class="input-group-btn">
...
<?php
$fields = array();
$ajax_url = base_url()."kiadok/truncate";
