...
<?php
$form_location = base_url().'termek/manage/20';
?>
<form action="<?=$form_location?>" method="get">
<div class="row-fluid sortable">
	<div class="box box-default">
		<div class="box-header with-border" data-original-title>
		<h3 class="box-title"><i class="fa fa-fw fa-search"></i> Keresés</h3> <a href="<?=base_url()?>termek/manage/20"><i class="fa fa-fw fa-close"></i></a>
		...
		<div class="box-body">			
			...
			<div class="col-xs-12 col-sm-6">
				<div class="input-group">
					...
					<select id="rendez" name="rendez" class="selectpicker form-control" data-live-search="true" title="terem_id">
						<option value="terem_id" <?=($rendez=="terem_id")?'selected':''?>>terem_id</option>
						<option value="terem_neve" <?=($rendez=="terem_neve")?'selected':''?>>terem neve</option>
		            </select>
                    <span class="input-group-btn">
...
<?php
$fields = array();
$ajax_url = base_url()."termek/truncate";
